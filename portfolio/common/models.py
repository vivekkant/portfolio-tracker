...
class Transaction(models.Model):
	...
	investment =  models.ForeignKey(Investment, blank=True, on_delete=models.CASCADE)
	price = models.DecimalField(max_digits=13, decimal_places=4, blank=False, default=0.0)
	quantity = models.DecimalField(max_digits=13, decimal_places=4, blank=False, default=0.0)
	fee = models.DecimalField(max_digits=13, decimal_places=4, blank=False, default=0.0)
	payee = models.CharField(max_length=100, blank=True, default='')
	category = models.CharField(max_length=100, blank=True, default='')
	debit = models.DecimalField(max_digits=13, decimal_places=4, blank=False, default=0.0)
	credit = models.DecimalField(max_digits=13, decimal_places=4, blank=False, default=0.0)
	notes = models.TextField(blank=True)
	created_date = models.DateTimeField(auto_now_add=True)
	updated_date = models.DateTimeField(auto_now=True)
